...
return {
    ...
    config = function()
        ...
        vim.api.nvim_set_hl(0, 'BufferVisibleMod' , {                              ctermbg=235, bg='#353535', ctermfg=153, fg='#aec7ff'})
        ...
        vim.api.nvim_set_hl(0, 'BufferInactiveMod', {                              ctermbg=235, bg='#262626', ctermfg=153, fg='#ffc775'})
